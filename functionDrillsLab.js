...
function theEliminator(arr) {
  for (let i = 0; i > contestants.length; i++){
    console.log(`${i+1}. ${contestants[i]}`) 
    let contestants = []
    let removeNames = contestants.splice(3,1)
  }
}
